...
public class GUI {
	...
	public static final String LANGUAGE = (String) JOptionPane.showInputDialog(null, "Choose a language to develop in.",
									"Which language?", JOptionPane.QUESTION_MESSAGE, null,
									LANGUAGES,
									"SILOS");
